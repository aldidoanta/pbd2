...
int main(void)
{
	...
	print_lcd(0, "PBD Ahay");	  
	print_lcd(1, "Quest 2");
	print_lcd(2, "Open the Chest");	  
	print_lcd(3, "Des 2013");	  	  
	Timer_initial();
	...
	{
			  close_seven_segment();
			  show_seven_segment(0,16);
				show_seven_segment(1,16);
				show_seven_segment(2,16);
				show_seven_segment(3,16);
			  delay_loop();
	}	  		
}
